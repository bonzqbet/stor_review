...
<div class="row" >
    ...
    <div class="col-lg-6">
        <div class="card" style="margin-top:50px">
          ...
          <h5 class="card-title" style="margin-top:30px;margin-left:20px">เพิ่มสินค้าในระบบ</h5>
            ...
            @endif
                <form action="{{ URL::route('store.create') }}" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="exampleInputEmail">ชื่อสินค้า</label>
                        <input type="text" class="form-control" name="Pname" placeholder="ชื่อสินค้า..." required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail">ราคาสินค้า</label>
                        <input type="number" class="form-control" name="price" placeholder="ราคาสินค้า..." required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail">รายละเอียดสินค้า</label>
                        <textarea name="Detail"  class="form-control" id="" cols="30" rows="4" placeholder="รายละเอียด..." required></textarea>
                    </div>

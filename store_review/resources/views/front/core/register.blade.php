    ...
    <div class="loginBack">
        <div class="login-form">
            ...
            <div class="body">
                ...
                <form class="form-default" action="{{ route('Login.create') }}" name="myFormLogin" id="myFormLogin">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input class="form-control" type="password" name="inputPassConfirm" id="inputPass" placeholder="Confirm Password">
                        </div>
                    </div>
                    <div class="form-btn">
                        <input class="btn btn-primary" name="input" type="submit" value="REGISTER" />
                    </div>
                </form>
                @if(isset($success))
